...
def main(_):
  ...
  saved_count = 0
  f_best_accuracy = open('/home/osboxes/PycharmProjects/ML_final_project/tmp/best_accuracy.txt', 'w')
  ...
  for i in range(FLAGS.how_many_training_steps):
    ...
    # Added by Guyra
    if validation_accuracy > best_validation_accuracy and validation_accuracy > 0.5:
        best_validation_accuracy = validation_accuracy
        saved_count += 1
        print('new best')
        output_graph_def = graph_util.convert_variables_to_constants(
            sess, graph.as_graph_def(), [FLAGS.final_tensor_name])
        with gfile.FastGFile(FLAGS.output_graph + 'best' + str(saved_count % 2), 'wb') as f:
            f.write(output_graph_def.SerializeToString())
        f_best_accuracy.write(str(best_validation_accuracy) + '\n')
        f_best_accuracy.flush()


  f_best_accuracy.close()
